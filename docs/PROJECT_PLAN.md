...
- **Long-tail audit leftovers (July 2026).** The full-quarantine audit ([SHIPPED entry](SHIPPED.md#long-tail-audit--four-scraper-promotions-dresher-the-lab-gray-area-mills-littlefield-july-2026)) promoted the four easy wins; Kuumbwa + the Santa Cruz region followed ([SHIPPED entry](SHIPPED.md#kuumbwa-jazz-center--the-santa-cruz-region-july-2026)), and Arc Gallery was **declined on data** (2 music events in 18 months — see the same entry). Still open: **effortful-but-real calendars** at Make-Out Room (HTTP-only RSS, lineups in post bodies), Meyhouse Jazz (Wix SSR, Peninsula jazz room), ATA (days-ahead posting horizon), The Monkey House (flyer images), Peacock Lounge and Shapeshifters Cinema (hand-edited HTML, low volume), and now-unblocked **Indexical** (easy server-rendered HTML, Santa Cruz region exists); **Santa Cruz Civic** (403s plain fetch — headless appetite); and a **human check on Temescal Arts Center** (Yelp says closed June 2026; BI still lists shows). **Unblock conditions:** explicit effort appetite per venue.
