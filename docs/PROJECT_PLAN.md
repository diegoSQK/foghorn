...
- **Venue batch 5, tranche B (July 2026 search sweep).** ~14 verified-green venues queued with known endpoints — see the [tranche A SHIPPED entry](SHIPPED.md#venue-batch-5-tranche-a-six-from-the-internet-search-sweep-july-2026) for the full queue, the yellow tier (Big Easy Petaluma is the prize), and the confirmed-dead list. **Unblock condition:** none — ready to build next session.
