...
- **Multi-user accounts.** ✅ Shipped August 2026 (invite-link auth, per-user watchlists, admin user management) — see [SHIPPED entry](SHIPPED.md#multi-user-accounts--vps-deployment-august-2026). Magic-link email recovery stays deferred until "ask Diego for a fresh link" is real friction.
